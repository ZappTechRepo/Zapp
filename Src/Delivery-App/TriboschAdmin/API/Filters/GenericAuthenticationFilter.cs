...
namespace TriboschAdmin.WebAPI.Filters
{
    ...
    /// <summary>
    /// Functioinallity for autorization filters
    /// </summary>
    ...
    /// <param name="filterContext"></param>  
    /// <returns></returns>  
    protected virtual bool OnAuthorizeUser(string user, string word, HttpActionContext filterContext) {
        if (string.IsNullOrEmpty(user) || string.IsNullOrEmpty(word)) return false;  
        return true;  
    }  
    ...
    /// R- add a response and tell the Basic realm
    /// </summary>  
    /// <param name="filterContext"></param>  
